...
namespace CapaPresentacion
{
    public partial class FrmEliminarCita : Form
    {
        ...
        {
            DialogResult result = MessageBox.Show("De verdad, ¿Quieres salir del formulario eliminar Cita?", "Volver al menú", MessageBoxButtons.YesNo);
            if (result == DialogResult.Yes)
            {
                this.Close();
            }
        ...
        private void FrmEliminarCita_Load(object sender, EventArgs e)
        {
